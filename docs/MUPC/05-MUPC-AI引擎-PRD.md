...
**电压变化斜率惩罚（v2.6 新增）：**
```
R_voltage_slope = |V_avg_t - V_avg_{t-1}| // 迫使 AI 平滑调节，避免电压突变
```
...
| w6 | 0.5 | 电压变化斜率惩罚权重（v2.6 新增） | [0.0, 2.0] |

> **v2.6 说明：**动作空间恢复3 维（新增 pv_limit 主动弃光）；奖励函数新增 w6 电压斜率惩罚，迫使 AI 平滑调节，避免电压快速变化对电网造成冲击。
